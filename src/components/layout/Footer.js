				...
				<div className='row'>
						...
						<ul className='list-unstyled pt-3'>
							<li>
								<p>
									...
									{city === 'Tegucigalpa'
										? 'Modalidad en línea únicamente '
										: null}
									{city === 'SPS'
										? 'Col Trejo 26 avenida 11 y12 calle Casa N. 1127'
										: null}
									{city === 'La Ceiba'
										? 'Residencial El Toronjal 2 de la calle Agropecuaria Popular a la UTH '
										: null}
								</p>
								<p>
									<i className='fas fa-clock mr-3'></i>
									Horarios de atencion Lunes a Sábado 8:00 AM a 5:00 PM
								</p>
							</li>
						</ul>
					</div>
					...
					<div className='col-md-6 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1'>
						...
						<ul className='list-unstyled pt-3'>
							...
							<li>
								<p className='m-0'>whatsapp SPS: +504 8732-4880</p>
								<p className='m-0'>whatsapp TGA: +504 3353-7895</p>
								<p className='m-0'>whatsapp CBA: +504 9997-7237</p>
							</li>
						</ul>
					</div>
					{/* <!-- Grid column --> */}
